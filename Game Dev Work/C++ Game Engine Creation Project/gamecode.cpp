...
Changes made to this file: Added code to create an instance of the level manager object and to handle the rendering, updating, and conditional deletion of all game objects by calling the functions of the instantiated object manager
*/
...
ErrorType Game::StartOfGame()
{
   ...
   // **********************************************************************
	...
	GameObject* pLevel = new LevelManager(&om);
	pLevel->Initialise(Vector2D(0.0, 0.0), 0.0f);
	om.AddObject(pLevel);
