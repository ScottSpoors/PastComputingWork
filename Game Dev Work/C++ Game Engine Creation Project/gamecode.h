...
Changes made to this file and why: Added an instance of the object manager class as a member variable so that other game objects can be created and managed for the game decoupled from the GameCode itself
*/
